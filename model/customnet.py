...
from deepnet.model.resnet import BasicBlock
...
class CustomNet(nn.Module):
    ...
    def learner(self, model, train_loader, test_loader, device, optimizer, criterion, epochs, sample_count, scheduler):
        """Trains the model
        Arguments:
        ...
        learn = Model(model, train_loader, test_loader, device, optimizer, criterion, epochs, sample_count, scheduler)
        self.train_losses, self.train_accuracies, self.test_losses, self.test_accuracies, self.correct_samples, self.incorrect_samples= learn.fit()
